...
{\contribution} \note[green]Все результаты, представленные в диссертации, получены лично автором либо при его непосредственном участии. Автор принимал активное участие в разработке новых методов обнаружения разгерметизации на ранних стадиях. Непосредственно автором предложена  \ldots}
